...
export default function About({  }) {
    return(
        <div className="px-10 overflow-x-hidden snap-y snap-proximity overflow-y-scroll h-screen">
            {/* opening */}
            <section className="flex lg:justify-around xs:justify-center lg:gap-0 xs:gap-20 lg:flex-row xs:flex-col-reverse items-center h-screen w-full">
                <div>
                ...
                <div className="relative lg:w-1/3 xs:w-9/10">
                    <div className="lg:grayscale xs:grayscale-0 hover:grayscale-0 hover:z-10 relative aspect-video">
                        <Image 
                            src='/myPict.jpg'
                            fill
                            alt="Me"
                    ...
                    <div className="absolute lg:w-50 sm:w-1/3 xs:w-1/2 lg:-top-1/4 md:top-1/2 sm:top-0 xs:-top-5 -left-10 lg:h-60 md:h-80 xs:h-60 object-cover object-top lg:grayscale xs:grayscale-0 hover:grayscale-0">
                        <Image 
                            src='/myPict2.jpg'
                            fill
                            alt="Me2"
                    ...
                    <div className="absolute lg:w-50 xs:w-1/2 lg:-right-20 sm:right-5 xs:right-1/5 sm:-bottom-1/4 xs:-bottom-30 h-35 object-cover object-center lg:grayscale xs:grayscale-0 hover:grayscale-0">
                        <Image 
                            src='/myPict3.jpg'
                            fill
                            alt="Me2"
            ...
            {/* about me */}
            <section className="lg:px-20 h-screen flex flex-col justify-center">
                <h2 className="text-4xl font-bold mb-5">Hi There...</h2>
                <SectionDivider />
                <div className="flex lg:flex-row xs:flex-col lg:gap-10 items-center">
                    <div className="lg:w-1/2 xs:w-9/10 aspect-video relative">
                        <Image 
                            src='/myPict.jpg'
                            fill
                            alt="Me"
                    ...
                    <div className="lg:w-1/2 xs:w-9/10 xs:mt-5 lg:mt-0">
            ...
            {/* skill */}
            <section className="lg:px-15 lg:h-screen xs:mt-15 lg:mt-0 flex flex-col justify-center">
                <h2 className="text-4xl text-center font-bold mb-5">Skills & Stack</h2>
                <div className="flex lg:flex-row xs:flex-col justify-between lg:gap-10 xs:gap-5">
                    ...
                    <div className="lg:w-1/3 flex flex-wrap gap-3 justify-center items-center">
            ...
            <section className="lg:px-15 lg:h-screen lg:mt-0 xs:mt-15 flex flex-col justify-center">
                <h2 className="text-4xl text-center font-bold">Education</h2>
                <p className="text-center text-lg text-textSec mb-5">Get to know more about my education  background</p>
                <div className="flex lg:flex-row xs:flex-col justify-center lg:gap-x-10 lg:items-start xs:items-center">
                    <div className="lg:w-1/2 text-justify">
                        <span className="text-textSec">2023 - Present</span>
                        <h3 className="text-2xl font-bold text-textMain">Indonesia University of Education</h3>
                        <span className="text-lg text-textSec block mb-3">Bachelor of Software Engineering</span>
                        <p className="mb-1.5">
                    ...
                    <div className="lg:w-1/2 lg:mt-0 xs:mt-10 xs:w-full">
                        <h3 className="text-center text-2xl font-bold ">Achievements</h3>
                        <p className="text-center text-lg text-textSec">Some of my achievements during my study</p>
                        <div className="lg:mt-10 xs:mt-5 flex flex-col gap-4">
                            <div className="py-5 px-5 shadow-xl border-2 border-gray-200 rounded-xl flex items-center gap-5 w-full">
                                <Icon.medal style={"w-8 h-8 fill-black"}/>
                                <div className="w-full">
                                    <h4 className="text-lg text-textMain font-bold">Excel Certification (MOS)</h4>
                                    <p className="text-gray-700 mb-2">Publisher: Microsoft</p>
            ...
            <section className="flex flex-col justify-center">
                <div className="text-center justify-self-start h-screen flex flex-col justify-center snap-center">
                    <p className="font-bold sm:text-4xl xs:text-xl">"Aut viam inveniam aut faciam"</p>
                    <p className="mt-2 text-lg text-textSec">"I shall either find a way or make one"</p>
                </div>
                <div className="mt-[10vh] mb-[40vh] flex flex-col justify-center text-center snap-center">
                    <span className="block text-2xl text-textSec tracking-widest mb-4">Let's know better</span>
                    <Link href={'/#contact'}>
                        <span className="block font-bold text-5xl hover:underline cursor-default select-none xs:underline lg:no-underline">
                            Get in Touch
                        </span>
                    </Link>
                </div>
